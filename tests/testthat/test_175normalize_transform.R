...
testing <- normalize(pombe_se, transform = "log2")
...
testing <- normalize(pombe_se, transform = "log10")
test_counts <- assay(testing)
...
testing <- normalize(pombe_se, transform = "log")
test_counts <- assay(testing)
...
testing <- normalize(pombe_se, transform = "voom", model_fstring = "~ condition", low_to_zero = FALSE)
test_counts <- assay(testing)
...
testing <- normalize(pombe_se, transform = "voomweight", model_fstring = "~ condition", low_to_zero = FALSE)
test_counts <- assay(testing)
expected <- c(-0.8820428, 0.5850832, -4.9695057, -3.3845431, 1.2593130,
              -4.9695057, -4.9695057, -2.6475776, -4.9695057, -4.9695057)
names(expected) <- test_genes
