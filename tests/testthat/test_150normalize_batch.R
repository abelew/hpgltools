...
testing <-  normalize_se(pombe_se, filter = TRUE, batch = "svaseq", surrogates = 1)
test_counts <- exprs(testing)
actual <- as.numeric(test_counts[1:10, 1])
...
testing <-  normalize_se(pombe_se, filter = TRUE, batch = "fsva", surrogates = 1)
test_counts <- exprs(testing)
actual <- as.numeric(test_counts[1:10, 1])
...
testing <-  sm(normalize_se(pombe_se, filter = TRUE, batch = "ssva"))
test_counts <- exprs(testing)
actual <- as.numeric(test_counts[1:10, 1])
...
testing <-  normalize_se(pombe_se, filter = TRUE, batch = "ruvg", surrogates = 1, thresh = 1)
test_counts <- exprs(testing)
actual <- as.numeric(test_counts[1:10, 1])
...
testing <-  normalize_se(pombe_se, filter = TRUE, batch = "combat")
test_counts <- exprs(testing)
actual <- as.numeric(test_counts[1:10, 1])
