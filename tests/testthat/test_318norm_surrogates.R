...
library(pasilla)
context("318norm_surrogates.R: Do surrogate estimators provide expected outputs?")
...
pasilla_svasup <- all_adjusters(pasilla_se,
...
pasilla_svaunsup <- all_adjusters(pasilla_se,
...
pasilla_pca <- all_adjusters(pasilla_se,
                             estimate_type = "pca",
                             num_surrogates = 2)
...
pasilla_ruvsup <- all_adjusters(pasilla_se,
...
pasilla_ruvresid <- all_adjusters(pasilla_se,
...
pasilla_ruvemp <- all_adjusters(pasilla_se,
