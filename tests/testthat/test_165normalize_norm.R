...
testing <- normalize(pombe_se, filter = TRUE, norm = "quant")
...
testing <- normalize(pombe_se, filter = TRUE, norm = "sf2")
test_counts <- assay(testing)
...
testing <- normalize(pombe_se, filter = TRUE, norm = "vsd")
test_counts <- assay(testing)
...
testing <- normalize(pombe_se, filter = TRUE, norm = "tmm")
test_counts <- assay(testing)
...
testing <- normalize(pombe_se, filter = TRUE, norm = "upperquartile")
test_counts <- assay(testing)
...
testing <- normalize(pombe_se, filter = TRUE, norm = "rle")
test_counts <- assay(testing)
