...
norm_expt <- normalize(fission_expt, transform = "log2", norm = "quant", convert = "cpm")
...
```{r}
normbatch_expt <- normalize(fission_expt, transform = "log2", norm = "quant",
...
batchnorm_expt <- normalize(fission_expt, batch = "sva", filter = TRUE,
...
```{r}
fission_boxplot <- plot_boxplot(fission_expt)
fission_boxplot

sf_expt <- normalize(fission_expt, norm = "sf")
fission_boxplot <- plot_boxplot(sf_expt)
fission_boxplot

tm_expt <- normalize(fission_expt, norm = "tmm")
fission_boxplot <- plot_boxplot(tm_expt)
fission_boxplot

rle_expt <- normalize_expt(fission_expt, norm = "rle")
fission_boxplot <- plot_boxplot(rle_expt)
fission_boxplot

up_expt <- normalize_expt(fission_expt, norm = "upperquartile")
fission_boxplot <- plot_boxplot(up_expt)
fission_boxplot
...
```{r variancePartition}
test_varpart <- simple_varpart(fission_expt)
