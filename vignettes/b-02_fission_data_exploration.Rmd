...
fis_info <- pca_information(norm_se,
                            se_factors = c("condition","batch","strain","minute"),
                            num_components = 6)
...
test_pca <- pca_information(batchnorm_se,
                            se_factors = c("condition","batch","strain","minute"),
                            num_components = 6)
```
...
rle_se <- normalize_se(fission_se, norm = "rle")
fission_boxplot <- plot_boxplot(rle_se)
fission_boxplot

up_se <- normalize_se(fission_se, norm = "upperquartile")
...
test_varpart <- simple_varpart(fission_se,
                               fstring = "~ strain + minute + replicate")
test_varpart[["percent_plot"]]
test_varpart[["partition_plot"]]
```
